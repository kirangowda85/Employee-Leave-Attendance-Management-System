...
public class EmployeeService {
    ...
    public EmployeeService(EmployeeRepository employeeRepository, UserRepository userRepository, LeaveBalanceRepository leaveBalanceRepository, LeavePolicyRepository leavePolicyRepository) {
    ...
    public ResponseEntity<ApiResponse> createEmployee(EmployeeRequestDTO dto) {
        ...
        Optional<LeavePolicy> leavePolicy =
                leavePolicyRepository.findByRoleIdAndYear(
